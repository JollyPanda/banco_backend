...
public class Transferencia {
	...
	// de forma opcional podemos indicar exáctamente el tipo que tendrá la fecha en
	// Base de Datos
	@Temporal(TemporalType.TIMESTAMP)
	private Date fecha;

	// se ejecuta antes de guardar por primera vez un Mensaje en Base de Datos
	// en este caso para asignar la fecha actual
	@PrePersist
